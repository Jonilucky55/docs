...
<AccordionGroup>
  ...
  <Accordion title="ASIA HR TEH " defaultOpen icon="rectangle-terminal" iconType="brands">
...
<AccordionGroup>
  <Accordion title="Install our GitHub app" icon="github">
    Install the Mintlify GitHub app from your [dashboard](https://dashboard.mintlify.com/settings/organization/githubasiahrteh-app).
